 ...
 * on 14-4-30.
 */
public class ScaleImageView extends ListView {
	...
	private void initHead() {
		headerView = new ImageView(mContext);
		headerView.setScaleType(ImageView.ScaleType.MATRIX);
		headerView.setImageResource(R.drawable.blue_sky);

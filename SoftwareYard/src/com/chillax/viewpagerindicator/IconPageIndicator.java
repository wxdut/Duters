 ...
 */
package com.chillax.viewpagerindicator;
...
public class IconPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    public IconPageIndicator(Context context, AttributeSet attrs) {
        ...
        mIconsLayout.setPadding(0,0,0,ScreenUtil.dp2px(context,15));
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            view.setLayoutParams(new ViewGroup.LayoutParams(ScreenUtil.dp2px(context,35),ScreenUtil.dp2px(context,35)));
